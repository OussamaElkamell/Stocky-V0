            ...
            <div className="ml-auto flex items-center gap-4">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={() => setShowLogoutConfirmation(true)}>Déconnexion</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
              <Dialog open={showLogoutConfirmation} onOpenChange={setShowLogoutConfirmation}>
                <DialogContent className="sm:max-w-[425px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Êtes-vous sûr de vouloir vous déconnecter ? Toutes les modifications non enregistrées seront
                      perdues.
                    </DialogDescription>
                  </DialogHeader>
  ...
  const subpages = isCommandes
    ...
    : isWebsiteBuilder
      ...
      : isRfid
        ...
        : isAnalytics
          ? [{ label: "Données Clients", href: "/dashboard/analytics/donnees-clients" }]
          : isSettings
            ? [
                {
                  label: "Livraison",
